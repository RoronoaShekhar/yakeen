...
import { Play, Download, Bookmark, Trash2 } from "lucide-react";
...
interface RecordedLectureItemProps {
  ...
  onDelete: (lecture: RecordedLecture) => void;
}
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-shrink-0 relative">
          <div className={`w-24 h-16 ${getSubjectColor(lecture.subject)} rounded-lg flex items-center justify-center shadow-md`}>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h5 className="text-base heading-secondary text-gray-800 truncate">
                {lecture.title}
              </h5>
